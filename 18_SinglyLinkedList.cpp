...
/*
숙제 : 학생관리 프로그램을 더블링크드리스트를 활용하여 만들어보자.
*/
...
{
	// 포인터는 가급적이면 초기활할때 NULL(0) 으로 초기화해두고 쓰는 것이 좋다.
	// 왜냐하면 0은 false, 0이 아닌 모든 수는 true이기 때문이다.
	// 초기화를 하지 않을 경우 쓰레기값이 들어가있는데 이 쓰레기값 조가 true이다.
	pList->pBegin = NULL;
	pList->pEnd = NULL;
	pList->iSize = 0;
}
...
void Delete(PLIST pList)
{
	...
	cout << endl << "삭제할 학생을 찾을 수 없습니다." << endl;
	system("pause");
}
