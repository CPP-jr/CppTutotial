...
void AddItem(_tagItem* pWeaponStore, _tagItem* pArmorStore)
{
	...
	// 사용할 아이템 배열을 따로 넣어주었다. 아이템을 추가할때도
	...
	*/
	...
	// 아이템 이름을 입력받는다.
	cout << "이름 : ";
	cin.getline(pItem->strName, ITEM_DESC_LENGTH - 1);
...
int main()
{
	...
	// 자동 저장기능. 저장을 하지 않더라도 프로그램이 종료될떄
	// 자동으로 저장되도록 한다.
	SaveStore(tWeapon, tArmor);
